...
extern char *degettext(const char *__domainname, const char *__msgid);
#else
DLL_EXPORTED char *dgettext(const char *__domainname, const char *__msgid)
       _INTL_MAY_RETURN_STRING_ARG (2);
#endif
...
extern char *dcgettext(const char *__domainname, const char *__msgid,
    int __category);
#else
DLL_EXPORTED char *dcgettext (const char *__domainname, const char *__msgid,
                        int __category)
       _INTL_MAY_RETURN_STRING_ARG (2);
#endif
...
extern char *ngettext(const char *__msgid1, const char *__msgid2,
    unsigned long int __n);
#else
DLL_EXPORTED char *ngettext (const char *__msgid1, const char *__msgid2,
                       unsigned long int __n)
       _INTL_MAY_RETURN_STRING_ARG (1) _INTL_MAY_RETURN_STRING_ARG (2);
#endif
...
extern char *dngettext(const char *__domainname, const char *__msgid1,
    const char *__msgid2, unsigned long int __n);
#else
DLL_EXPORTED char *dngettext (const char *__domainname,
...
extern char *dcngettext(const char *__domainname,
    ...
    unsigned long int __n, int __category);
#else
DLL_EXPORTED char *dcngettext (const char *__domainname,
                         const char *__msgid1, const char *__msgid2,
                         unsigned long int __n, int __category)
       _INTL_MAY_RETURN_STRING_ARG (2) _INTL_MAY_RETURN_STRING_ARG (3);
#endif
...
#else
DLL_EXPORTED char *textdomain (const char *__domainname)
...
extern char *bindtextdomain(const char *__domainname,
    const char *__dirname);
#else
DLL_EXPORTED char *bindtextdomain (const char *__domainname, const char *__dirname)
...
extern char *bind_textdomain_codeset(const char *__domainname,
    const char *__codeset);
#else
DLL_EXPORTED char *bind_textdomain_codeset (const char *__domainname,
                                      const char *__codeset)
